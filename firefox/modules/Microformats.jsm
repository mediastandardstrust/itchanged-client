var EXPORTED_SYMBOLS = ["Microformats", "adr", "tag", "hCard", "hCalendar", "geo", "bookmark", "hNews"];
...
function hNews(node) {
  if (node) {
    Microformats.parser.newMicroformat(this, node, "hNews");
  }
}

hNews.prototype.toString = function() {
  return this["entry-title"];
}

var hNews_definition = {
  mfVersion: 0.8,
  description: "News Article(s)",
  mfObject: hNews,
  className: "hnews",
  required: ["source-org", "entry-title", "updated"],
  properties: {
    "author" : {
      datatype: "microformat",
      microformat: "hCard"
...
Microformats.add("hNews", hNews_definition);
